...
#'
#' The primary phenotype is time to hatch (`tth`).  An additional
#' "phenotype", `female`, indicates maternal cytoplasmic environment (the
#' source of the egg).
#'
...
#'
#' Note that the data have cross type `"dh"` (for doubled haploids); in
...
#' *Oncorhynchus mykiss*. *Genetics* **175**, 335--347.
#'
