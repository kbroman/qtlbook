...
#'
#' Data from doubled haploid individuals derived from a cross between Oregon
#' State University (OSU) and Clearwater (CW) River rainbow trout clonal lines.
#'
#' Doubled haploid individuals were produced from a cross between Oregon State
#' University (OSU) and Clearwater (CW) river rainbow trout (\emph{Oncorhynchus
...
#' maternal nuclear DNA and fertilized with sperm from a single \eqn{F_1}{F1}
...
#' "phenotype", \code{female}, indicates maternal cytoplasmic environment (the
#' source of the egg).
#'
#' There are genotype data on 171 markers on 28 linkage groups.  The linkage
#' groups are named as in Nichols et al. (2002), though a pair of markers are
#' assigned to linkage group "un", as they don't connect to any of the linkage
#' groups in Nichols et al. (2002).
#'
#' Note that the data have cross type \code{"dh"} (for doubled haploids); in
...
#' \emph{Oncorhynchus mykiss}. \emph{Genetics} \bold{175}, 335--347.
#'
#' Nichols, K. M., Young, W. P., Danzmann, R. G., Robison, B. D., Rexroad, C.,
#' Noakes, M., Phillips, R. B., Bentzen, P., Spies, I., Knudsen, K., Allendorf,
#' F. W., Cunningham, B. M., Brunelli, J., Zhang, H., Ristow, S., Drew, R.,
#' Brown, K. H., Wheeler, P. A. and Thrgaard, G. H. (2002) A consolidated
#' linkage map for rainbow trout (\emph{Oncorhynchus mykiss}).  \emph{Animal
#' Genetics} \bold{34}, 102--115.
